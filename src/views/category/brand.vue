...
<style lang="scss" rel="stylesheet/scss" scoped>
	...
	.thumb{line-height: 16vw;height: 16vw;overflow: hidden;}
	ul{margin-right: -30px;clear: both;}
	li{width: 22%;text-align: center; float: left;margin-bottom: 30px;margin-right: 1%;font-size: .7rem;box-sizing: border-box;
		img{width: 80%;}
	}
}
</style>