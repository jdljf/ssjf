	...
	<div id="newLife" :class="'newLife'+$store.state.service.lang">
		<div class="m-header">
			<div class="info">
				...
				<p class="single"><span>{{language.nickname}}</span><label style="color: #fff;">{{title.nickname}}</label></p>
				<p class="single"><span>{{language.leve}}</span><label style="color: #fff;">{{title.leve}}</label></p>
				<p class="single"><span>积分：</span><label style="color: #D64D31;">{{score}}</label></p>
			</div>
		...
		<div class="proxy">
			<span>{{language.exer}}<b style="color: #FC442E;">{{title.exer}}</b></span> 
