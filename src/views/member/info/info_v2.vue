<template >
	...
	<yd-cell-group title="基本信息">
        <yd-cell-item>
            ...
            <yd-input slot="right" type="tel"   v-model="info_form.mobile" required regex="mobile"  :show-success-icon="false" :show-error-icon="false"  :show-clear-icon="false" max="11" placeholder="请输入手机号"></yd-input>
	   				<span slot="right" style="width:100px;">{{bind_btn}}</span>
	    </yd-cell-item>
			<yd-cell-item @click.native="bindTel"  v-else >
            <span slot="left">手机号：</span>
