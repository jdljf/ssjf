<template>
    <div id="teamAgentCenter">
        ...
        <c-title :hide="false" text='组织收益'></c-title>
        
        <div style="height:40px"></div>
        <div class="sharetop">
			<div class="moneys">¥<span style="margin-left: 5px;">{{team_data.settle_money_total}}</span></div>
			<div class="lastmoney">账户余额</div>
			<div class="reflect" style="display: none;">立即提现</div>
			<div class="addmoney">累计结算收益:¥{{team_data.settle_money_total}}</div>
		</div>
		<div class="liarr">
			<div class="lisss">
				<div class="li">
					<span class="r">结算收入</span>
					<span style="font-size: 14px;">¥{{team_data.last_month.settle}}</span>
					<span class="l">上月佣金</span>
				</div>
				<div class="li">
					<span class="r">预估收入</span>
					<span style="font-size: 14px;">¥{{team_data.this_month}}</span>
					<span class="l">本月佣金</span>
				</div>
				<div class="li">
					<span class="r">预估收入</span>
					<span style="font-size: 14px;">¥{{team_data.last_month.money}}</span>
					<span class="l">上月佣金</span>
				</div>
			</div>
		</div>
		<div class="liarr">
			...
			<div class="lisss">
				<div class="li">
					...
					<span style="font-size: 14px;">{{team_data.today.count}}</span>
					
				</div>
				<div class="li">
					<span class="r">预估佣金</span>
					<span style="font-size: 14px;">¥{{team_data.today.money}}</span>
					
				</div>
				<div class="li">
					<span class="r">其他</span>
					<span style="font-size: 14px;">¥{{team_data.today.extra}}</span>
		...
		<div class="liarr">
			...
			<div class="lisss">
				<div class="li">
					<span class="r">结算收入</span>
					<span style="font-size: 14px;">{{team_data.yesterday.count}}</span>
					
				</div>
				<div class="li">
					<span class="r">结算收入</span>
					<span style="font-size: 14px;">¥{{team_data.yesterday.money}}</span>
					
				</div>
				<div class="li">
					<span class="r">结算收入</span>
					<span style="font-size: 14px;">¥{{team_data.yesterday.extra}}</span>
        ...
        <div class="content">
            ...
            <!--<el-tabs v-model="activeName" >
                <el-tab-pane :label="mailDividend" name="first" style="width: 100%;">-->
                    <ul class='rationList' style="width: 100%;" v-if="detailshow">
                        <li v-for="elem in first_content" style="width: 100%;">
                            <div class="detail">
