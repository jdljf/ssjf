...
export default {
	...
	methods: {
		...
		initMailLanguage() {
			...
			this.fun.setWXTitle(this.fun.setMailLanguage("组织提成分润中心", this.mailLanguage.team_dividend.team_agent_centre));
			this.mailTeamDividendTitle = this.fun.setMailLanguage("组织提成分润中心", this.mailLanguage.team_dividend.team_agent_centre);
...
//
//					let settle_money_total = new Object();
//					settle_money_total.money = response.data.settle_money_total;
//					settle_money_total.data = "已结算";
//					settle_money_total.name = "data";
//					that.ratioDatas.push(settle_money_total);
//
//					let not_settle_money_total = new Object();
//					not_settle_money_total.money = response.data.not_settle_money_total;
//					not_settle_money_total.data = "未结算" ;
//					not_settle_money_total.name = "data";
//					that.ratioDatas.push(not_settle_money_total);
//
