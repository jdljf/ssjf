...
export default {
    ...
    components: { cTitle, cMent, cGoodsList, banner, showbanner, showsign, showmenu, showtitle, showsearch, showline, showblank, showrichtext, showpicture, showcube, showarea, showshop, showgoods, shownotice, showlocation, showstore, cMyswipe, Swipe, SwipeItem, showbread },
