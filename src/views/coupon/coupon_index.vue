                ...
                <div class="coupon_card">
                    <mt-tab-container-item id="1">
                        ...
                        <div class="coupon_voucher  bg_dong  newarrive" v-for='(item,index) in wait_used'>
                            ...
                            <mt-cell-swipe title="" :right="[{content: '删除', style: { width: '100px',height: '20px',background: 'red', color: '#fff' },
                      handler: () => {delteteItem(item,index)}}]">
                                ...
                                <div class="coupon_voucher_main">
                                    ...
                                    <div class="coupon_voucher_right">
                                        ...
                                        <p style="padding-top: 20px;text-align: left;" class="coupon_voucher_period">{{item.time_start}}-{{item.time_end}}</p>

                                        <p style="position: absolute;bottom: 10px;"  class="coupon_voucher_more on" @click='toggle($event,index)'>详细
