<template>
	<div id="goodslist">
			...
			<div  @click="toRouter(items.id)" v-for="items in stores">
				<div class="list">
					...
					<div class="store-intro">
						...
						<div class="discount">
							<p><span style="margin-right:10px;" v-if="items.store_point.point_switch == 0?false:true">{{items.store_point.point}}</span><span v-if="items.store_point.point_deduct_switch == 0?false:true">{{items.store_point.max_point_deduct}}</span></p>
							<p><span style="margin-right:10px;" v-if="items.store_love.award==1?true:false">{{items.store_love.award_proportion}}</span><span v-if="items.store_love.deduction==1?true:false">{{items.store_love.deduction_proportion}}</span></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="loadNomore" v-if="stores.length <= 0"><img src="../assets/images/no-more-product.png"/></div>
	</div>
</template>
