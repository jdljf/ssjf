...
router.beforeEach(function(to, from, next) {
	...
	if(to.path) {
		...
		_hmt.push(['_setCustomVar', 1, '用户身份', window.localStorage.level_name, 1]);
		_hmt.push(['_setCustomVar', 1, '用户组织信息', window.localStorage.team_names, 1]);
		_hmt.push(['_setCustomVar', 1, '用户姓名_手机号', window.localStorage.nickname, 1]);
	}
